...
function vHome(){
  ...
  <section class="block"><details><summary>Where the numbers come from</summary><div><p class="note">Department ceilings for Development, Finance, Administration and Sales follow the occupational figures in Anthropic's "Labour Market Impacts of AI" (March 2026), which compares theoretical and observed AI coverage. Marketing, HR, Travel and Operations are blended estimates. Supporting figures: McKinsey State of AI 2025, JetBrains Developer Ecosystem 2025. Every benchmark is replaced by your own answers as you audit.</p></div></details></section>`;
}
